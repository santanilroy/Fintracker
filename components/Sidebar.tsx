  ...
  return (
    <>
      <div className="w-64 h-full fixed text-neutral-800 p-4 border-r border-neutral-300 dark:border-neutral-700 dark:bg-neutral-950 bg-gray-100">
        <div className="text-[15px] text-neutral-50 font-roboto tracking-normal bg-neutral-950 dark:bg-neutral-500/30 dark:backdrop-blur-2xl dark:shadow-mauve-200 dark:shadow-xs w-28 flex justify-center items-center py-2 rounded-md ">
          Fintracker
